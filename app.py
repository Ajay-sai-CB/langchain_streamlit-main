...
def write_top_bar():
    ...
    with col2:
        ...
        header = f"Takeuchi Knowledge Base Search: Find the answers you need, fast."
...
st.markdown('---')
input = st.text_input("You are talking to an AI, ask any question about takeuchi.", key="input", on_change=handle_input)
